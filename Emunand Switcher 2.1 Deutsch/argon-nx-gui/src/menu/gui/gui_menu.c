...
static bool render_switcherSX_tab(lv_obj_t* par, argon_ctxt_t* ctxt) //Eigener Tab SwitcherSX
{
	...
	if (f_stat("emunandswitcher/config.ini", NULL)) {
		...
		lv_label_set_text(label, "Config.ini nicht vorhanden\noder fehlerhaft!");
...
static bool render_tools_tab(lv_obj_t* par, argon_ctxt_t* ctxt)
{
	...
	lv_label_set_text(sonst_label, LV_SYMBOL_SETTINGS" Konfigurations Tools");
	...
	label = lv_label_create(settings_tab, NULL);
	lv_label_set_text(label, "Config.ini bearbeiten");
	...
	label = lv_label_create(settings_tab, NULL);
	lv_label_set_text(label, "RTC Zeit und Datum");
	...
	label = lv_label_create(settings_tab, NULL);
	lv_label_set_text(label, "Display Helligkeit");
