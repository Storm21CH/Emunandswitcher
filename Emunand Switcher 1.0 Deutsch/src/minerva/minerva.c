...
static u32 increase_freq(mtc_config_t* mtc_cfg, u32 from, u32 to, enum train_mode_t train_mode)
{
	...
	return ianos_loader(false, "emunandswitcher/sys/minerva.bso", DRAM_LIB, (void *)mtc_cfg);
}
...
void minerva()
{
	...
	if (ianos_loader(false, "emunandswitcher/sys/minerva.bso", DRAM_LIB, (void *)&mtc_cfg) != 0)
    {
