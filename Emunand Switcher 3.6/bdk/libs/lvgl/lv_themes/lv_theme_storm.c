...
#define ARGON_ORANGE        LV_COLOR_HEX(0x0045ff)
 ...
 */
lv_theme_t * lv_theme_storm_init(uint16_t hue, lv_font_t * font)
{
 ...
 */
lv_theme_t * lv_theme_get_storm(void)
{
	return &theme;
}
