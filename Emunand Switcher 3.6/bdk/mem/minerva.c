...
u32 minerva_init()
{
	...
	if (mtc_cfg->init_done == MTC_INIT_MAGIC)
	{
		...
		u32 ep_addr = ianos_loader("emunandswitcher/sys/minerva.bso", DRAM_LIB, (void*)mtc_cfg);
	...
	else
	{
		...
		u32 ep_addr = ianos_loader("emunandswitcher/sys/minerva.bso", DRAM_LIB, (void*)&mtc_tmp);
