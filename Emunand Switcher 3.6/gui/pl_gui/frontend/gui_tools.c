...
static lv_res_t _create_mbox_ums(usb_ctxt_t* usbs)
{
	...
	if (usbs->type == MMC_SD)
	{
		...
		{
		case 0:
			s_printf(text_buf + strlen(text_buf), "#FFFFFF SD Card#");
			break;
		case EMMC_GPP + 1:
			s_printf(text_buf + strlen(text_buf), "#FFFFFF emuMMC GPP#");
			break;
		case EMMC_BOOT0 + 1:
			s_printf(text_buf + strlen(text_buf), "#FFFFFF emuMMC BOOT0#");
			break;
		case EMMC_BOOT1 + 1:
			s_printf(text_buf + strlen(text_buf), "#FFFFFF emuMMC BOOT1#");
			break;
		}
	}
	else
	{
		...
		{
		case EMMC_GPP + 1:
			s_printf(text_buf + strlen(text_buf), "#FFFFFF eMMC GPP#");
			break;
		case EMMC_BOOT0 + 1:
			s_printf(text_buf + strlen(text_buf), "#FFFFFF eMMC BOOT0#");
			break;
		case EMMC_BOOT1 + 1:
			s_printf(text_buf + strlen(text_buf), "#FFFFFF eMMC BOOT1#");
			break;
		}
	}
