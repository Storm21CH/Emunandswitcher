...
void ipl_main()
{
    ...
    if (sd_mount())
    {
		...
		bool load_menu = cancel_auto_chainloading || launch_payload("");
        
		const char* s = "Loading Emunandswitcher...";
		...
		gfx_printf(&g_gfx_con, "%k%s%k", MYBLUE, s, BLACK);

     /*   gfx_printf(&g_gfx_con, "Loading Emunandswitcher...\n"); */
